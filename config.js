...
module.exports = {
  botname: process.env.BotName || "HDK-BOTZ", 
  author: process.env.Author || "@HDKBotz",
  packname: process.env.PackName || "HDKv2",
  socialLink: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© HDK-Botz",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "HDK",
  ownernumber: process.env.Owner_Number || "6282142439989",
